...
module.exports = {
  ...
  DATA_SCIENCE_MANAGER_HANDLES: process.env.DATA_SCIENCE_MANAGER_HANDLES ? process.env.DATA_SCIENCE_MANAGER_HANDLES.split(',') : ['ketzjs09', 'Oanh.Tran', 'sdguntcqa', 'sdgun', 'jcori'],
